...
![screenshot from browser tools](../assets/googledevtools.png)

You can also select the arrow in the top left corner of the inspector tools and click on the element you want to inspect.

![screenshot with arrow](../assets/googledevtoolsarrow.png)
